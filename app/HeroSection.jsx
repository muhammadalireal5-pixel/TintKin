  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-80px)] bg-base selection:bg-lavender selection:text-primary">
      ...
      <section className="flex-1 flex flex-col lg:flex-row relative overflow-hidden">
        ...
        <div className="w-full lg:w-[60%] flex flex-col justify-center px-8 lg:px-20 py-20 z-10">
          
          <div className="tk-anim-1 inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-sage/10 border border-sage/20 w-fit mb-8">
          ...
          <h1 className="tk-anim-2 text-5xl lg:text-7xl font-display font-medium leading-[1.1] tracking-tight text-primary mb-6 max-w-3xl">
            A daily journal for your <span className="italic text-sage/90">skin’s</span> journey.
          </h1>

          <p className="tk-anim-3 text-lg lg:text-xl text-muted leading-relaxed max-w-xl mb-12">
          ...
          <div className="tk-anim-4 flex flex-col sm:flex-row items-center gap-4">
            <Link href="/capture" className="tk-pill-btn tk-btn-primary flex items-center justify-center gap-2 w-full sm:w-auto shadow-[0_8px_24px_rgba(44,62,80,0.12)]">
              Begin your entry
        ...
        <div className="w-full lg:w-[40%] relative min-h-[500px] lg:min-h-full tk-mesh-bg flex items-center justify-center p-12">
